...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-07-2022 a las 06:00:08
...
ALTER TABLE `alumno`
  ...
  ADD KEY `fk_carreraeva3` (`carrera`);
...
--
ALTER TABLE `alumno`
  ADD CONSTRAINT `fk_carreraeva3` FOREIGN KEY (`carrera`) REFERENCES `carrera` (`id_carrera`);
COMMIT;
